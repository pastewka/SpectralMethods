...
\(2N+1\) Fourier-Basisfunktionen, Gl. \eqref{eq:fourier-basis}. Im Rahmen einer
Kollokationsmethode, verlangen wir, dass das Residuum auf \(2N+1\) äquidistanten
Punkten verschwindet, \(R(y_n)=0\) mit \begin{equation} y_n = n L / (2N+1). \end{equation}
...
</p><!-- l. 95 --><p class='indent'>   Als einfaches Beispiel zeigen wir hier Approximation der Beispielfunktion
...
<!-- l. 106 --><p class='noindent'></p><!-- l. 107 --><p class='noindent'><img width='585' src='Figures/coll5.svg' alt='PIC' height='249' />
</p><!-- l. 110 --><p class='noindent'><img width='585' src='Figures/coll11.svg' alt='PIC' height='256' />
<a id='x1-3001r1'></a>
<a id='x1-3002'></a>
</p>
...
<!-- l. 117 --><p class='indent'>   Die Abbildung zeigt, dass alle Approximationen, wie von der
...
<!-- l. 122 --><p class='noindent'>Wir möchten nun die Kollokationsmethode verallgemeinern. Hierzu führen wir
...
</p><!-- l. 129 --><p class='indent'>   Ein spezieller Satz an Testfunktion führt direkt zur Kollokationsmethode.
...
für alle \(n\in [0,N-1]\) führt direkt zur Kollokationsbedingung \(R(y_x)=0\).
   ...
   <div class='framedenv' id='shaded*-1'>
<!-- l. 136 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Anmerkung:</span></span> Die Diracsche \(\delta \)-Funktion sollte aus Vorlesungen zur Signalverarbeitung
...
</p><!-- l. 175 --><p class='indent'>   Wir wollen nun wieder zu unserer Beispielfunktion \(f(x)=\sin (2\pi x)^3 + \cos (6\pi (x^2-1/2))\) zurückkommen.
...
<!-- l. 186 --><p class='noindent'></p><!-- l. 187 --><p class='noindent'><img width='585' src='Figures/gal5.svg' alt='PIC' height='249' />
</p><!-- l. 190 --><p class='noindent'><img width='585' src='Figures/gal11.svg' alt='PIC' height='247' />
<a id='x1-5001r2'></a>
<a id='x1-5002'></a>
</p>
...
abbilden.
   ...
   <div class='framedenv' id='shaded*-1'>
<!-- l. 197 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Anmerkung:</span></span> Die Galerkin-Bedingung (siehe auch Gl. \eqref{eq:galerkinortho})
...
<!-- l. 207 --><p class='noindent'>Ein alternativer Ansatz zur Approximation ist es, das Fehlerquadrat des
