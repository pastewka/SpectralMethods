...
<!-- l. 131 --><p class='noindent'><img height='229' width='390' alt='PIC' src='Figures/fourierbasis.svg' /> <a id='x1-5001r1'></a>
<a id='x1-5002'></a>
</p>
...
konstruiert, dass \(\int _0^L \dif x\,\varphi _n(x)=(x_{n+1}-x_{n-1})/2\). Diese Basis ist die einfachste Form der finite Elemente-Basis
...
<!-- l. 165 --><p class='noindent'><img height='115' width='390' alt='PIC' src='Figures/febasis.svg' /> <a id='x1-6001r2'></a>
<a id='x1-6002'></a>
</p>
...
<!-- l. 171 --><p class='indent'> Ein wichtiger Hinweis an dieser Stelle ist, dass die Basis der finiten Elemente
