...
</p><!-- l. 56 --><p class='indent'> Gleichung \eqref{eq:afterpartialint} hat nun <span class='cmti-12'>keine </span>zweite Ableitung mehr.
...
<!-- l. 58 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Anmerkung:</span></span> Die linearen Basisfunktionen sind im klassischen Sinne noch
...
</p><!-- l. 176 --><p class='indent'> In Verlauf dieses Lernmaterials ist bislang vollkommen unter den Tisch gefallen,
