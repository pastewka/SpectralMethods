...
<div id='shaded*-1' class='framedenv'>
<!-- l. 176 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Die Basisfunktionen der zweidimensionalen Fourier-Reihe sind gegeben
...
durch:
</p><!-- l. 176 --><p class='indent'> \begin {equation} \begin {split} \left (\varphi _{k_x,k_y}, \varphi _{k_x',k_y'} \right ) &amp;= \frac {1}{L_x L_y}\int _0^{L_y} \int _0^{L_x} \dif x \dif y \, \left [ \exp {\left (-\frac {2\pi i}{L_x}k_x x - \frac {2\pi i}{L_y}k_y y\right )} \right . \\ &amp; \qquad \qquad \qquad \left . \exp {\left (\frac {2\pi i}{L_x}k_x' x + \frac {2\pi i}{L_y}k_y' y \right )} \right ]\\ &amp;= \frac {1}{L_x L_y}\int _0^{L_y} \dif y\, \left [ \exp {\left (\frac {2\pi i}{L_y}\left (k_y'-k_y \right ) y \right )} \right . \\ &amp; \qquad \qquad \qquad \left .\int _0^{L_x} \dif x\, \exp {\left (\frac {2\pi i}{L_x}\left ( k_x' - k_x \right ) x \right )} \right ] \end {split} \end {equation}
</p><!-- l. 176 --><p class='indent'> Durch die Ergebnisse aus Aufgabe 1.1 (Glg. \eqref{eq:A1˙1D˙unterschiedliche˙f}
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 214 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Wir projizieren \(f(x,y)\) auf die zweidimensionale Fourierreihen-Basis:
\begin {equation} \begin {split} f(x,y) =&amp; \sum _{k=-\infty }^{\infty } \left [ \left ( \exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )},f \right ) \right . \\ &amp; \qquad \left ( \exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )},\exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )} \right )^{-1} \\ &amp; \qquad \left . \exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )} \right ]\\ =&amp; \sum _{k=-\infty }^{\infty } c_k \exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )} \end {split} \end {equation}
Aus Aufgabe 1.2 folgt, dass <br class='newline' />\(\left ( \exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )},\exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )} \right ) = 1\). Die Koeffizienten der Fourier-Reihe sind also gegeben durch: \begin {equation} \begin {aligned} c_k &amp;= \left ( \exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )},f \right ) \\ &amp;= \frac {1}{L_x L_y}\int _0^{L_y}\int _0^{L_x} \dif x \dif y \, \left (\exp {\left (\frac {2\pi i}{L_x}k_x x + \frac {2\pi i}{L_y}k_y y\right )}\right )^* f(x,y) \\ &amp;= \frac {1}{L_x L_y}\int _0^{L_y}\int _0^{L_x} \dif x \dif y \, f(x,y) \exp {\left (-\frac {2\pi i}{L_x}k_x x - \frac {2\pi i}{L_y}k_y y\right )} \end {aligned} \end {equation}
</p></div>
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 249 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Seien \(v(x)\) die Testfunktionen. Dann folgt aus Glg. \eqref{eq:Diffusion}:
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 281 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> In der Galerkin-Methode werden die Basisfunktionen \(\varphi _j\) als Testfunktionen
...
</p><!-- l. 281 --><p class='indent'> \begin {equation} \begin {split} D \sum _i a_i \left [ \varphi _j(x) \frac {\partial \varphi _i(x)}{\partial x} \right ]_0^L - D \sum _i a_i \int _0^L \dif x \, \frac {\partial \varphi _j(x)}{\partial x}\frac {\partial \varphi _i(x)}{\partial x} \\= \int _0^L \dif x \, \varphi _j(x) f(x) \qquad \forall j \end {split} \label {eq:Diffusion_Galerkin} \end {equation}
</p></div>
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 403 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Wir betrachten die Glg. \eqref{eq:Diffusion˙Galerkin} für \(j \in {1; N-2}\). Dann ist \(\varphi (0) = \varphi (L) = 0\),
...
Es bleibt also: \begin {equation} \begin {split} - a_{j-1}D\int _0^L \dif x \, \left (\frac {\partial \varphi _j(x)}{\partial x}\frac {\partial \varphi _{j-1}(x)}{\partial x}\right ) - a_j D\int _0^L \dif x \, \left (\frac {\partial \varphi _j(x)}{\partial x}\frac {\partial \varphi _j(x)}{\partial x}\right ) \\- a_{j+1}D\int _0^L \dif x \, \frac {\partial \varphi _j(x)}{\partial x}\frac {\partial \varphi _{j+1}(x)}{\partial x} = \int _0^L \dif x \, \varphi _j(x) f(x) \end {split} \label {eq:A2_Diffusion_Galerkin_innen} \end {equation}
Sei \(\Delta x=\frac {L}{N-1}\) der Abstand zwischen zwei Gitterpunkten. Dann sind die Hutfunktionen und
ihre Ableitungen gegeben durch: \begin {equation} \varphi _j = \begin {cases} \frac {1}{\Delta x}x - \frac {x_{j-1}}{\Delta x}\quad x \in [x_{j-1}; x_j] \\ -\frac {1}{\Delta x}x + \frac {x_{j+1}}{\Delta x}\quad x \in [x_{j}; x_{j+1}] \\ 0 \quad x \notin [x_{j-1}; x_{j+1}] \end {cases} \end {equation}
\begin {equation} \frac {\partial \varphi _j}{\partial x} = \begin {cases} \frac {1}{\Delta x} \quad x \in (x_{j-1}; x_j) \\ -\frac {1}{\Delta x} \quad x \in (x_{j}; x_{j+1}) \\ 0 \quad x \notin (x_{j-1}; x_{j+1}) \end {cases} \end {equation}
Die Integrale auf der linken Seite von Glg. \eqref{eq:A2˙Diffusion˙Galerkin˙innen}
sind also: \begin {equation} \begin {aligned} &amp;\int _0^L \dif x \, \frac {\partial \varphi _j(x)}{\partial x}\frac {\partial \varphi _{j-1}(x)}{\partial x} = -\frac {1}{\Delta x^2} \left (x_j - x_{j-1} \right ) = -\frac {1}{\Delta x} \\ &amp;\int _0^L \dif x \, \frac {\partial \varphi _j(x)}{\partial x}\frac {\partial \varphi _{j}(x)}{\partial x} = \frac {1}{\Delta x^2} \left (x_{j+1} - x_{j-1} \right ) = \frac {2}{\Delta x} \\ &amp;\int _0^L \dif x \, \frac {\partial \varphi _j(x)}{\partial x}\frac {\partial \varphi _{j+1}(x)}{\partial x} = -\frac {1}{\Delta x^2} \left (x_{j+1} - x_{j} \right ) = -\frac {1}{\Delta x} \end {aligned} \end {equation}
...
</p><!-- l. 403 --><p class='indent'> 2. Quellterm: \(f(x) = f_0\) Die rechte Seite von Glg. \(\ref {eq:A2_Diffusion_Diskret}\) ist: \begin {equation} \begin {aligned} \int _0^L \dif x \, \varphi _j(x) f(x) &amp;= \int _0^L \dif x \, \varphi _j(x) f_0 \\ &amp;= \frac {f_0}{\Delta x} \left ( x_j^2 + \frac {1}{2}x_{j-1}^2 + \frac {1}{2}x_{j+1}^2 - x_j x_{j-1} - x_j x_{j+1}\right ) \\ &amp;= f_0 \Delta x \end {aligned} \end {equation}
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 455 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> \begin {equation} \begin {aligned} 0 &amp;= \frac {1}{L}\int _0^L \dif x \, c(x) \\ &amp;= \frac {1}{L} \sum _i a_i \int _0^L \dif x \, \varphi _i(x) \\ &amp;= \frac {1}{L} a_0 \int _0^L \dif x \, \varphi _0(x) + \frac {1}{L} \sum _{i=1}^{N-2} a_i \int _0^L \dif x \, \varphi _i(x) + a_{N-1} \int _0^L \dif x \, \varphi _{N-1}(x) \\ &amp;= \frac {1}{N-1} \left ( \frac {a_0}{2} + \sum _{i=1}^{N-2} a_i + \frac {a_{N-1}}{2} \right ) \end {aligned} \end {equation}
</p></div>
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 520 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Wir fordern periodische Randbedingungen, d.h. \(c(0) = c(L)\), woraus folgt dass \(a_0 = a_{N-1}\). Zusammen
mit der Mittelwertbedingung und Glg. \eqref{eq:A2˙Diffusion˙Diskret˙Constant}
ergibt sich ein System von 4 Gleichungen. In Matrix-Schreibweise: \begin {equation} \frac {1}{\Delta x} \begin {pmatrix} \Delta x &amp; 0 &amp; 0 &amp; -\Delta x \\ 1 &amp; -2 &amp; 1 &amp; 0 \\ 0 &amp; 1 &amp; -2 &amp; 1 \\ \Delta x / 2 &amp; \Delta x &amp; \Delta x &amp; \Delta x / 2 \end {pmatrix} \cdot \begin {pmatrix} a_0 \\ a_1 \\ a_2 \\ a_3 \end {pmatrix} = \begin {pmatrix} 0 \\ -\frac {1}{D} \\ \frac {1}{D} \\ 0 \end {pmatrix} \end {equation}
</p><!-- l. 520 --><p class='indent'> Die Systemmatrix ist also gegeben durch: \begin {equation} \underline {K} = \frac {1}{\Delta x} \begin {pmatrix} \Delta x &amp; 0 &amp; 0 &amp; -\Delta x \\ 1 &amp; -2 &amp; 1 &amp; 0 \\ 0 &amp; 1 &amp; -2 &amp; 1 \\ \Delta x / 2 &amp; \Delta x &amp; \Delta x &amp; \Delta x / 2 \end {pmatrix} \end {equation}
</p><!-- l. 520 --><p class='indent'> Hier legitime alternative Schreibweisen zwecks schnellerer Korrektur:
</p><!-- l. 520 --><p class='indent'> \[\underline {K} =\left ( \begin {array}{cccc} \frac {1}{2} &amp; 1 &amp; 1 &amp; \frac {1}{2} \\ 1 &amp; -2 &amp; 1 &amp; 0 \\ 0 &amp; 1 &amp; -2 &amp; 1 \\ 1 &amp; 0 &amp; 0 &amp; -1 \\ \end {array}\right )\], \[\vec {f}=\left (\begin {array}{c} 0 \\ -\frac {\Delta x}{D} \\ \frac {\Delta x}{D} \\ 0 \\ \end {array}\right )\]. </p></div>
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 599 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Sie finden den Lösungcode hier: <a href='solution_233.py' class='url'><span class='cmtt-12'>solution_233.py</span></a>. Dieser erzeugt
...
</p><!-- l. 599 --><p class='indent'> <img alt='PIC' src='solution_233.svg' />
</p><!-- l. 599 --><p class='indent'> Es fällt auf, dass die analytische Lösung und die zwei FEM Lösungen für
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 688 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Dirichlet Randbedingung: \begin {equation} c(0) = a_0 = c_0 \end {equation}
</p><!-- l. 688 --><p class='indent'> Neumann Randbedingung: Wir betrachten die Glg. \eqref{eq:Diffusion˙Galerkin}
für \(\varphi _{N-1}\): \begin {equation} \begin {split} D \left ( \varphi _{N-1}(L) \sum _i a_i \left . \frac {\partial \varphi _i(x)}{\partial x}\right \vert _{x=L} - \varphi _{N-1}(0) \sum _i a_i \left . \frac {\partial \varphi _i(x)}{\partial x}\right \vert _{x=0}\right ) \\ - D\sum _i a_i \int _0^L \dif x \, \frac {\partial \varphi _{N-1}(x)}{\partial x}\frac {\partial \varphi _i(x)}{\partial x} = \int _0^L \dif x \, \varphi _{N-1}(x) f(x) \end {split} \end {equation}

</p><!-- l. 688 --><p class='indent'> \begin {equation} \Leftrightarrow \frac {D}{\Delta x} a_{N-2} - \frac {D}{\Delta x} a_{N-1} = - Dc_L' + \int _0^L \dif x \, \varphi _{N-1}(x) f(x) \end {equation}
</p><!-- l. 688 --><p class='indent'> 1. Quellterm: Für zwei Delta-Distributionen als Quellterm ist die rechte Seite
dieser Gleichung: \begin {equation} \begin {aligned} - Dc_L' + \int _0^L \dif x\, \varphi _{N-1}(x) f(x) &amp;= - Dc_L' -\varphi _{N-1}\left (\frac {L}{3}\right ) + \varphi _{N-1}\left (\frac {2L}{3}\right ) \\ &amp;= - Dc_L' \qquad \text {für } N \geq 4 \end {aligned} \end {equation}
...
</p><!-- l. 688 --><p class='indent'> 2. Quellterm: Für einen konstanten Quellterm ist die rechte Seite der
...
bestimmen. </p></div>
<div id='shaded*-1' class='framedenv'>
<!-- l. 806 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Sie finden den Lösungscode hier: <a href='solution_242.py' class='url'><span class='cmtt-12'>solution_242.py</span></a>. Dieser Code
produziert folgende Grafiken:
</p><!-- l. 806 --><p class='indent'> <img alt='PIC' src='solution_242_concentration.svg' />
</p><!-- l. 806 --><p class='indent'> Die Lösung mit Delta-Distributionen als Quellterm ist wie im periodischen
...
</p><!-- l. 806 --><p class='indent'> <img alt='PIC' src='solution_242_matrix_struktur.svg' />
</p><!-- l. 806 --><p class='indent'> Dieser Plot zeigt die Struktur der Systemmatrix. Man erkennt, dass diese eine
...
sind.
</p><!-- l. 806 --><p class='indent'> <img alt='PIC' src='solution_242_derivative.svg' />
</p><!-- l. 806 --><p class='indent'> Auf diesem dritten Plot kann man beobachten, dass die FEM-Lösung zwar
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 871 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Seien \(v(x)\) die Testfunktionen. Dann folgt aus Glg. \eqref{eq:A5˙Poisson˙Boltzmann}:
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 896 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> In Glg. \eqref{eq:A5˙schwache˙Form} werden \(\Phi (x) = \sum _i a_i \varphi _i(x)\) und die Testfunktionen \(v(x) = \varphi _j(x)\)
eingesetzt: \begin {equation} \begin {aligned} \left [ \varphi _j(x) \frac {\partial \Phi (x)}{\partial x}\right ]_0^L - \sum _i a_i \int _0^L \dif x\, \left ( \frac {\partial \varphi _j(x)}{\partial x}\frac {\partial \varphi _i(x)}{\partial x} + \frac {1}{\lambda ^2}\varphi _i(x)\varphi _j(x)\right ) = 0 \end {aligned} \end {equation}
</p></div>
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 933 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Für \(j \in \{1; 2; ...; N-2\}\) sind die Testfunktionen am Rand null, so dass der Randterm aus
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 949 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> An Plattenkondensatoren ist das elektrostatische Potential fest
...
<div id='shaded*-1' class='framedenv'>
<!-- l. 1019 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Lösung:</span></span> Sie finden den Lösungcode hier: <a href='solution_255.py' class='url'><span class='cmtt-12'>solution_255.py</span></a>. Dieser erzeugt
folgende Grafik:
</p><!-- l. 1019 --><p class='indent'> <img alt='PIC' src='solution_255.svg' /> Diese Grafik zeigt die numerische Lösung der 1D-Poisson-Boltzmann
