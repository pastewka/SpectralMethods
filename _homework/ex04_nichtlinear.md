...
<div class='lstlisting' id='listing-3'><span class='label'><a id='x1-7001r1'></a><span class='cmr-6'>1</span></span><span class='cmtt-10'>def f(x): </span><br /><span class='label'><a id='x1-7002r2'></a><span class='cmr-6'>2</span></span><span class='cmtt-10'>    return x * x - 1 </span><br /><span class='label'><a id='x1-7003r3'></a><span class='cmr-6'>3</span></span><span class='cmtt-10'>def df(x): </span><br /><span class='label'><a id='x1-7004r4'></a><span class='cmr-6'>4</span></span><span class='cmtt-10'>    return 2 * x</span>
</div>
...
<!-- l. 173 --><p class='noindent'>Wir wenden uns nun der Lösung der eindimensionalen Poisson-Boltzmann-Gleichung
...
<!-- l. 180 --><p class='noindent'><span class='cmbx-12'>3 Punkte</span><br class='newline' />Zunächst muss die nichtlineare Poisson-Gleichung diskretisiert werden. Führen
...
<div class='framedenv' id='shaded*-1'>
<!-- l. 183 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Anmerkung:</span></span> Wenn Sie finite Elemente ansetzen, dann reicht es die Basisfunktionen
...
<!-- l. 197 --><p class='noindent'><span class='cmbx-12'>2 Punkte</span><br class='newline' />Die finalen Gleichungen für das (diskrete) Residuum enthalten Terme der Form \((\varphi _k, \sinh \Phi _N)\),
...
<!-- l. 208 --><p class='noindent'><span class='cmbx-12'>3 Punkte</span><br class='newline' />Leiten Sie die Tangentenmatrix her. Zeigen Sie, welche Form die Tangentenmatrix
...
<div class='framedenv' id='shaded*-1'>
<!-- l. 290 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Anmerkung:</span></span> Es ist wichtig, dass die Funktion <span class='cmtt-12'>tangent </span>die korrekte(n)
...
<!-- l. 344 --><p class='noindent'><span class='cmbx-12'>7 Punkte</span><br class='newline' /> </p><div class='framedenv' id='shaded*-1'>
<!-- l. 345 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Anmerkung:</span></span> Falls ihr Newton-Löser für multidimensionale Probleme
...
<!-- l. 349 --><p class='indent'> Implementierung Sie die Lösung der nichtlinearen Poisson-Boltzmann-Gleichung
...
<div class='framedenv' id='shaded*-1'>
<!-- l. 351 --><p class='noindent'><span class='underline'><span class='cmbx-12'>Anmerkung:</span></span> </p>
<ul class='itemize1'>
...
Newton-Lösers ungefähr so aussehen: <!-- l. 355 -->
...
<!-- l. 360 --><p class='noindent'>Unter Umständen wollen Sie noch eine Callback-Funktion übergeben, um
die Konvergenz des Lösers zu verfolgen.



</p><!-- l. 362 --><p class='noindent'>Zusätzlich sollten Sie noch die Potentialrandbedingungen und zusätzliche
...
<!-- l. 375 --><p class='noindent'>Sie können auf diesem Übungsblatt insgesamt 32 Punkte erzielen.
</p>
