...
Löser, der \(f(x) = 0\) nach einfachem Newton-Iterationsverfahren lokal löst. Nutzen Sie
hierfür folgende Schnittstelle: </p><!-- l. 44 -->
...
Funktionswert \(|f(x_i)|&lt;\varepsilon \) erfüllt. Um Situationen zu vermeiden, in denen keine Konvergenz
erreicht werden kann, sieht die Funktion noch eine maximale Anzahl an
Schritten (Parameter <span class='obeylines-h'><span class='verb'><span class='cmtt-12'>maxiter</span></span></span>) vor. Die Iteration wird abgebrochen, wenn
...
Sie die Schritte des Newton-Solvers für Startpunkt \(x_0=0.9\) und \(x_0=-1.1\), in dem Sie die die
...
und reguläre Gitter. Dies entspricht exakt dem Vorgehen aus den vorigen
Übungsblättern.
</p>
<div class='framedenv' id='shaded*-1'>
...
Skalerprodukte/Integrale die nicht analytisch gelöst werden können mit Hilfe
die Art numerischer Quadratur. Fixieren Sie hier noch nicht die Anzahl der
...
<!-- l. 329 --><p class='noindent'><span class='cmbx-12'>7 Punkte</span><br class='newline' /> </p><div class='framedenv' id='shaded*-1'>
